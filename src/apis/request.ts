...
import { ERRORS } from '@utils/staticData';
import TokenProvider from '@utils/authenticate/TokenProvider';
...
const AUTH_URL_REFRESH_TOKEN = `${Config.API_URL}${PATH_API.REFRESH}`;
